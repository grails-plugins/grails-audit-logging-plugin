...
. Add `https://repo.grails.org/grails/restricted` to the build repositories when resolving the snapshot. Use Maven Central and a released version when a released 7.x artifact is available.
