 ...
 *
 * See Documentation:
 * https://github.com/gpc/grails-audit-logging-plugin
 *
 */
@Slf4j
...
class AuditLoggingGrailsPlugin extends Plugin {
    ...
    """
    String documentation = 'https://github.com/gpc/grails-audit-logging-plugin'
    ...
    def issueManagement = [system: 'GitHub', url: 'https://github.com/gpc/grails-audit-logging-plugin/issues']
    def scm = [url: 'https://github.com/gpc/grails-audit-logging-plugin']
